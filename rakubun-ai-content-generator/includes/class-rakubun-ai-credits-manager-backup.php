...
class Rakubun_AI_Credits_Manager {
    ...
    public static function get_user_credits($user_id) {
        ...
        // Try to get credits from external API first
        ...
        // Fallback to local database if external API is not available
        return self::get_local_credits($user_id);
    }
    ...
    public static function deduct_credits($user_id, $credit_type, $amount = 1) {
        ...
        return self::deduct_local_credits($user_id, $credit_type, $amount);
    }
